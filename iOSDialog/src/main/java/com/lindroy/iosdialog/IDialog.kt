...
object IDialog {
    ...
    internal val alertPosBtnParams by lazy {
        TextParams(
    ...
    internal val alertNegBtnParams by lazy {
        TextParams(
            getSpSize(R.dimen.ios_alert_button_text_size),
            textColorRed,
    ...
    class Config {
        ...
        fun setAlertPosButton(
            text: String = alertPosBtnParams.text,
            textSize: Float = alertPosBtnParams.textSize,
            @ColorInt textColor: Int = alertPosBtnParams.textColor,
            gravity: Int = alertPosBtnParams.gravity
        ) = this.apply {
            alertPosBtnParams.also {
                it.text = text
                it.textSize = textSize
                it.textColor = textColor
                it.gravity = gravity
        ...
        fun setAlertNegButton(
            text: String = alertNegBtnParams.text,
            textSize: Float = alertNegBtnParams.textSize,
            @ColorInt textColor: Int = alertNegBtnParams.textColor,
            gravity: Int = alertNegBtnParams.gravity
        ) = this.apply {
            alertNegBtnParams.also {
                it.text = text
                it.textSize = textSize
                it.textColor = textColor
                it.gravity = gravity
